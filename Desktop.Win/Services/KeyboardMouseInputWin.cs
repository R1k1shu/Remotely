    ...
    ILogger<KeyboardMouseInputWin> _logger) : IKeyboardMouseInput
{
    ...
    private bool ConvertJavaScriptKeyToVirtualKey(string key, [NotNullWhen(true)] out VirtualKey? result)
    {
        result = key switch
        {
            ...
            "KeyA" => VirtualKey.KEY_A,
            "KeyB" => VirtualKey.KEY_B,
            "KeyC" => VirtualKey.KEY_C,
            "KeyD" => VirtualKey.KEY_D,
            "KeyE" => VirtualKey.KEY_E,
            "KeyF" => VirtualKey.KEY_F,
            "KeyG" => VirtualKey.KEY_G,
            "KeyH" => VirtualKey.KEY_H,
            "KeyI" => VirtualKey.KEY_I,
            "KeyJ" => VirtualKey.KEY_J,
            "KeyK" => VirtualKey.KEY_K,
            "KeyL" => VirtualKey.KEY_L,
            "KeyM" => VirtualKey.KEY_M,
            "KeyN" => VirtualKey.KEY_N,
            "KeyO" => VirtualKey.KEY_O,
            "KeyP" => VirtualKey.KEY_P,
            "KeyQ" => VirtualKey.KEY_Q,
            "KeyR" => VirtualKey.KEY_R,
            "KeyS" => VirtualKey.KEY_S,
            "KeyT" => VirtualKey.KEY_T,
            "KeyU" => VirtualKey.KEY_U,
            "KeyV" => VirtualKey.KEY_V,
            "KeyW" => VirtualKey.KEY_W,
            "KeyX" => VirtualKey.KEY_X,
            "KeyY" => VirtualKey.KEY_Y,
            "KeyZ" => VirtualKey.KEY_Z,
            "Digit0" => VirtualKey.KEY_0,
            "Digit1" => VirtualKey.KEY_1,
            "Digit2" => VirtualKey.KEY_2,
            "Digit3" => VirtualKey.KEY_3,
            "Digit4" => VirtualKey.KEY_4,
            "Digit5" => VirtualKey.KEY_5,
            "Digit6" => VirtualKey.KEY_6,
            "Digit7" => VirtualKey.KEY_7,
            "Digit8" => VirtualKey.KEY_8,
            "Digit9" => VirtualKey.KEY_9,
            ...
            "NumpadEnter" => VirtualKey.RETURN,
            "Space" => VirtualKey.SPACE,
            "Comma" => VirtualKey.OEM_COMMA,
            "Period" => VirtualKey.OEM_PERIOD,
            "Slash" => VirtualKey.OEM_2,
            "Semicolon" => VirtualKey.OEM_1,
            "Quote" => VirtualKey.OEM_7,
            "BracketLeft" => VirtualKey.OEM_4,
            "BracketRight" => VirtualKey.OEM_6,
            "Backslash" => VirtualKey.OEM_5,
            "Backquote" => VirtualKey.OEM_3,
            "Minus" => VirtualKey.OEM_MINUS,
            "Equal" => VirtualKey.OEM_PLUS,
            _ => key.Length == 1 ?
